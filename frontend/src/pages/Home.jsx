        ...
        <div className="flex-col  justify-start">
          <div className="container px-4 my-30 sm:px-8 md:px-12 lg:px-20">
            ...
            <div className="flex flex-col lg:flex-row justify-center w-full">
              ...
              > 
                <h1 className="text-3xl sm:text-4xl lg:text-5xl text-white font-extrabold font-[anton]  [text-shadow:8px_8px_16px_rgba(255,255,255,0.5)]  text-center">
            ...
            <motion.div
              ...
              > 
              <h1 className="text-5xl sm:text-6xl lg:text-8xl text-white font-extrabold font-[alata] [text-shadow:8px_8px_16px_rgba(255,255,255,0.5)] my-5 px-3 text-center">
          ...
          <div className='slide-left flex flex-col justify-center items-center'>
            <h1 className='text-5xl text-white font-extrabold m-5 text-center font-[alata] [text-shadow:8px_8px_16px_rgba(255,255,255,0.5)]'>Open Source Contributions</h1>
            <GitHubHeatmap />
          </div>
          </div>
